...
### Enable defarg operation (CronJob)
- For more information about defrag look [here](https://etcd.io/docs/v3.2/op-guide/maintenance/#defragmentation)
- For more information related to the chart's defrag configuration look [defrag-README.md](./defrag-README.md)
