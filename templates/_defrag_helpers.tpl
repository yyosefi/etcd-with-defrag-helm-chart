...
{{- define "etcd-defrag.defrag.flags" -}}
  {{ include "etcd-defrag.defrag.flag.commandTimeout" . }} {{ include "etcd-defrag.defrag.flag.debug" . }} {{ include "etcd-defrag.defrag.flag.dialTimeout" . }} {{ include "etcd-defrag.defrag.flag.insecureSkipTlsVerify" . }} {{ include "etcd-defrag.defrag.flag.insecureTransport" . }} {{ include "etcd-defrag.defrag.flag.user" . }} {{ include "etcd-defrag.defrag.flag.writeOut" . }}
{{- end -}}
